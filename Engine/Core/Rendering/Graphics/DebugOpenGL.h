...
/*********************************************************************************************/
	...
	#define checkFramebufferErrorsGL(__name__) __checkFramebufferErrorsGL(__FILE__, __LINE__, std::string(__name__))

	#define checkGeneralErrorGL(__name__) __checkGeneralErrorGL(__FILE__, __LINE__, std::string(__name__))
